...
class ViewTaskOrderScreen extends StatelessWidget {
  const ViewTaskOrderScreen({Key? key}) : super(key: key);
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Icon(Icons.person, color: AppColors().defaultColor, size: 45.w,),
                                      SizedBox(width: 10.w,),
                                      Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Icon(Icons.location_pin, color: AppColors().defaultColor, size: 40.w,),
                                      SizedBox(width: 11.w,),
                                      Text(
                                        "134, High street, \nOsman Mohamed, EG.",
                                        style: TextStyle(
                                      ...
                                      SizedBox(width: 8.w,),
                                      SvgPicture.asset("assets/icons/Date_icon.svg", width: 37.w,),
                                      SizedBox(width: 8.w,),
                                      Padding(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      SizedBox(width: 5.w,),
                                      SvgPicture.asset("assets/icons/Phone_icon.svg", color: AppColors().defaultColor,width: 32.w,),
                                      SizedBox(width: 16.w,),
                                      Padding(
                                      ...
                                      SizedBox(width: 20.w,),
                                      SvgPicture.asset("assets/icons/Clock_icon.svg", width: 30.w,),
                                      SizedBox(width: 12.w,),
                                      Padding(
                                        padding: EdgeInsets.symmetric(vertical: 5.h),
                                        child: Text(
