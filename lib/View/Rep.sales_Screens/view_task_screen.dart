...
class ViewTaskScreen extends StatelessWidget {
  const ViewTaskScreen({Key? key, required this.clientName, required this.locationName, required this.phoneNumber, required this.durationTo, required this.TimeTo, required this.descripttion, this.long, this.lat, this.reasonOfVisit, this.repSalesDescription}) : super(key: key);
