...
import 'home_screen_acc.dart';

class MainPageAcc extends StatefulWidget{
  ...
  @override
  State<MainPageAcc> createState() => _MainPageState();

}

class _MainPageState extends State<MainPageAcc>{

  List<bool> iconsActivate = List.filled(4, false);
  final List<Widget> pageList = <Widget>[HomeScreenAcc(),  ViewScreen(), const ChatScreen(), ];
