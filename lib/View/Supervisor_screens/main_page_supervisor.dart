...
class MainPageSupervisor extends StatefulWidget{

  int selectedItemPosition;

  MainPageSupervisor({Key? key,
    required this.selectedItemPosition
  }) : super(key: key);

  @override
  State<MainPageSupervisor> createState() => _MainPageState();

}

class _MainPageState extends State<MainPageSupervisor>{

  List<bool> iconsActivate = List.filled(4, false);
  final List<Widget> pageList = <Widget>[HomeScreenSupervisor(), const ChatScreen()];
