...
class EditClientScreen extends StatefulWidget {
  ...
  @override
  State<EditClientScreen> createState() => _CreatePipeLineScreenState();
}

class _CreatePipeLineScreenState extends State<EditClientScreen> {
                ...
                for(var element in clientList){
                  if(element.name == selectedClient){
                    setState(() {
                      ...
                      clientEmailController.text = element.email;
                      clientNameController.text = element.name;
                      clientLocationLat.text = element.latitude.toString();
                      clientLocationLng.text = element.longitude.toString();
                      clientLocationPhoneNumber.text = element.phoneNumber;
