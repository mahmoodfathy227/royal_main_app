...
class SpecificAddClientScreen extends StatefulWidget {
  const SpecificAddClientScreen({Key? key}) : super(key: key);

  @override
  State<SpecificAddClientScreen> createState() => _CreateUserScreenState();
}

class _CreateUserScreenState extends State<SpecificAddClientScreen> {
  ...
  List<UserType> userTypeList = [ UserType(userType: "Client"),];
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child:   TextFormField(
                              ...
                              onTap: (){
                                Navigator.push(context , MaterialPageRoute( builder: (BuildContext context) => const MapUserScreen() ));
                              },
                          ...
                          Padding(
                            ...
                            child: CustomTextFormField(
                              ...
                              onSave: (value){
                                email = value;
                                print("this is saved email ${email}");
                              },
                              validator: (value){
                                if (!(value.contains('@')) ||
                                    !(value.contains('.com')) ||
